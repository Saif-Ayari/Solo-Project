...
export const createPost = async (req, res) => {
    ...
    const newPostBlog = new PostBlog({ title, message, selectedFile, creator, tags })

    try {
        await newPostBlog.save();

        res.status(201).json(newPostBlog );
    } catch (error) {
...
export const updatePost = async (req, res) => {
    ...
    await PostBlog.findByIdAndUpdate(id, updatedPost, { new: true });
